...
loop2:
    ...
    LD      r8, 16(r4)                   ; load nums[j]
    DADD    r9, r7, r8                  ; sum = nums[i] + nums[j]      
    BEQ     r9, r2, found               ; if(sum == target) -> found   
    DADDI   r5, r5, 1                   ; else increment j
    BEQ     r5, r1, loop1               ; if(j != n) -> inner loop

    LD      r8, 24(r4)                   ; load nums[j]
    DADD    r9, r7, r8                  ; sum = nums[i] + nums[j]      
    BEQ     r9, r2, found               ; if(sum == target) -> found   
    DADDI   r5, r5, 1                   ; else increment j
    BEQ     r5, r1, loop1               ; if(j != n) -> inner loop

    LD      r8, 32(r4)                   ; load nums[j]
    DADD    r9, r7, r8                  ; sum = nums[i] + nums[j]      
    BEQ     r9, r2, found               ; if(sum == target) -> found  
    DADDI   r5, r5, 1                   ; else increment j
    BEQ     r5, r1, loop1               ; if(j != n) -> inner loop

    LD      r8, 40(r4)                   ; load nums[j]
    DADD    r9, r7, r8                  ; sum = nums[i] + nums[j]     
    BEQ     r9, r2, found               ; if(sum == target) -> found  
    DADDI   r5, r5, 1                   ; else increment j
    BEQ     r5, r1, loop1               ; if(j != n) -> inner loop

    LD      r8, 48(r4)                   ; load nums[j]
    DADD    r9, r7, r8                  ; sum = nums[i] + nums[j]     
    BEQ     r9, r2, found               ; if(sum == target) -> found  
    DADDI   r5, r5, 1                   ; else increment j
    BEQ     r5, r1, loop1               ; if(j != n) -> inner loop

    LD      r8, 56(r4)                   ; load nums[j]
    DADD    r9, r7, r8                  ; sum = nums[i] + nums[j]     
    BEQ     r9, r2, found               ; if(sum == target) -> found  
    DADDI   r5, r5, 1                   ; else increment j
    BEQ     r5, r1, loop1               ; if(j != n) -> inner loop
